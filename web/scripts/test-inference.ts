...
const r1 = inferSkillGap('engineer', CURRICULUM_SEED, [], {}, []);
...
const r2 = inferSkillGap('engineer', CURRICULUM_SEED, ['C2B'], { t1: 'high' }, t2Tasks);
...
const r3 = inferSkillGap('marketer', CURRICULUM_SEED, [], {}, []);
